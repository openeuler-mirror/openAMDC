...
set samples {}
while 1 {
    exec openamdc-cli -p $::fail_port debug sleep $::sleep_time > /dev/null &

    # Wait for fail? to appear.
    while 1 {
        set output [exec openamdc-cli -p $::other_port cluster nodes]
    ...
    exec openamdc-cli -p $::fail_port ping
