 ...
 * and may not be called in the busy loops where openAMDC tries to release
 ...
 * conficting with openAMDC user code. */
#include <libproc.h>
#endif
 ...
 * 3) Was modified for openAMDC by Matt Stancliff.
