...
/* Release the skiplist mapping openAMDC Cluster keys to slots in the
 * lazyfree thread. */
...
int dbAsyncDelete(redisDb *db, robj *key) {
    ...
    if (de) {
         ...
         * of parts of the openAMDC core may call incrRefCount() to protect
...
/* Empty a openAMDC DB asynchronously. What the function does actually is to
...
/* Release the radix tree mapping openAMDC Cluster keys to slots asynchronously. */
