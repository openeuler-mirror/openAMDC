...
/* The openAMDC HyperLogLog implementation is based on the following ideas:
 *
 ...
 * * The use of the openAMDC string data type. No new type is introduced.
 ...
 *
 * OpenAMDC uses two representations:
 *
 ...
 * ===
 *
 * The dense representation used by openAMDC is the following:
 *
 * +--------+--------+--------+------//      //--+
 ...
 * It was modified for openAMDC in order to provide the same result in
...
void hllDenseRegHisto(uint8_t *registers, int* reghisto) {
    ...
    /* OpenAMDC default is to use 16384 registers 6 bits each. The code works
...
void pfcountCommand(client *c) {
    ...
    if (o == NULL) {
        ...
        if (HLL_VALID_CACHE(hdr)) {
             ...
             * may be modified and given that the HLL is a openAMDC string
