 ...
 *
 * OpenAMDC uses an approximation of the LRU algorithm that runs in constant
 ...
 *
 * It's possible for openAMDC to suddenly be significantly over the "maxmemory"
 ...
 * this, it's important to evict for a managed period of time - otherwise openAMDC
