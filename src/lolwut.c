 ...
 * This is what unstable versions of openAMDC will display. */
void lolwutUnstableCommand(client *c) {
    sds rendered = sdsnew("openAMDC ver. ");
    rendered = sdscat(rendered,OPENAMDC_VERSION);
