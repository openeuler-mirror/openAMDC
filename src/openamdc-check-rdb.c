...
/* RDB check main: called form server.c when openAMDC is executed with the
 * openamdc-check-rdb alias, on during RDB loading errors.
 *
...
int redis_check_rdb_main(int argc, char **argv, FILE *fp) {
     ...
     * an already initialized openAMDC instance, check if we really need to. */
