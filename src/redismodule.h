...
/* The command is running inside a openAMDC transaction */
...
/* openAMDC is currently running inside background child process. */
...
/* When set, openAMDC will not call RedisModule_SignalModifiedKey(), implicitly in
...
#define REDISMODULE_SUBEVENT_LOADING_ROCKSDB_START 6
...
/* This is included inline inside each openAMDC module. */
