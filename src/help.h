...
struct commandHelp {
  ...
  char *since;
    ...
    { "CLUSTER INFO",
    "-",
    "Provides info about openAMDC Cluster node state",
    12,
    "3.0.0" },
    { "CLUSTER KEYSLOT",
    "key",
    ...
    { "COMMAND",
    "-",
    "Get array of openAMDC command details",
    9,
    "2.8.13" },
    { "COMMAND COUNT",
    "-",
    "Get total number of openAMDC commands",
    9,
    "2.8.13" },
    { "COMMAND GETKEYS",
    "-",
    "Extract keys given a full openAMDC command",
    9,
    "2.8.13" },
    { "COMMAND INFO",
    "command-name [command-name ...]",
    "Get array of specific openAMDC command details",
    9,
    "2.8.13" },
    { "CONFIG GET",
    "parameter",
    ...
    { "LOLWUT",
    "[VERSION version]",
    "Display some computer art and the openAMDC version",
    9,
    "5.0.0" },
    { "LPOP",
    "key [count]",
    ...
    "Atomically transfer a key from a openAMDC instance to another one.",
    0,
    "2.6.0" },
    { "MODULE LIST",
    "-",
    ...
    "Inspect the internals of openAMDC objects",
    0,
    "2.2.3" },
    { "PERSIST",
    "key",
    ...
    { "SLAVEOF",
    "host port",
    "Make the server a replica of another instance, or promote it as master. SLAVEOF has been deprecated. Use REPLICAOF instead.",
    9,
    "1.0.0" },
    { "SLOWLOG",
    "subcommand [argument]",
    "Manages the openAMDC slow queries log",
    9,
    "2.2.12" },
    { "SMEMBERS",
    "key",
