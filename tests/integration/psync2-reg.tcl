...
# openamdc-benchmark. At the end we check that the data is the same
# everywhere.
...
start_server {} {
    ...
    set bench_pid [exec src/openamdc-benchmark -s $R_unixsocket(0) -n 10000000 -r 1000 incr __rand_int__ > /dev/null &]
    while 1 {
